import React, { Component, useState, useEffect, useContext, Context } from "react";
...
export default class MapPage extends Component {
  ...
  return (
    <Grid container id="main" style={{flexGrow: 1,
      justifyContent: "center"}} spacing={2}>
      <Grid item id="map">
        <Map data={this.state.apiProperty} city={this.state.currentCity} />
      </Grid>
      <Grid item id="sidebar">
        <Sidebar data={this.state.apiProperty} getProperties={this.getProperties} setCity={this.setCurrentCity} />
      </Grid>
    </Grid>
  );
  }
